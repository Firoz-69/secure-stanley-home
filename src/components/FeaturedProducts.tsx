...
const FeaturedProducts = () => {
  ...
  const getBadgeColor = (badge: string) => {
    switch (badge) {
      ...
      case 'New Arrival': return 'bg-success-green text-white';
      case 'Top Rated': return 'bg-warning-yellow text-steel-gray';
      case 'Value Pick': return 'bg-secondary text-secondary-foreground';
      default: return '';
    }
  };
        ...
        <div className="flex justify-between items-end mb-12">
          <div>
            ...
            <p className="text-xl text-muted-foreground max-w-2xl">
              Discover our most popular safety equipment trusted by professionals worldwide.
            </p>
          </div>
