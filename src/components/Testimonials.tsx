      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Don't just take our word for it. Here's what industry professionals say about their experience with Stanley Safety Products.
          </p>
        </div>
                ...
                <div className="bg-card p-8 lg:p-12 rounded-2xl shadow-[var(--shadow-elegant)] border border-border/50">
                  ...
                  <div className="flex justify-center gap-1 mb-6">
                    {[...Array(testimonial.rating)].map((_, i) => (
                      <Star key={i} className="h-5 w-5 text-warning-yellow fill-current" />
                    ))}
                  </div>
        ...
        <div className="mt-16 pt-16 border-t border-border/50">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 opacity-60">
            ...
            <div className="text-2xl font-bold text-muted-foreground">ABC Construction</div>
            <div className="text-2xl font-bold text-muted-foreground">Industrial Solutions</div>
            <div className="text-2xl font-bold text-muted-foreground">Steel Manufacturing</div>
            <div className="text-2xl font-bold text-muted-foreground">Metro Projects</div>
            <div className="text-2xl font-bold text-muted-foreground">Infra Corp</div>
          </div>
        </div>
      </div>
    </section>
